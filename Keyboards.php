...
if (isset($_POST['search'])) {
    ...
    $sql = "SELECT * FROM product WHERE title LIKE '%$q%' AND category='klaviatura'";
} else {
    $sql = "SELECT * FROM product WHERE category='klaviatura'";
}
    ...
    while ($row = mysqli_fetch_assoc($results)) {
        ...
        <div class="product">
            <div class="product-header">
                ...
                <a><img class="productimg" src="foto/atb/keyboard/keyboard1.png"></a>
            </div>
            <div class="productdisc">
                ...
                <div class="action">
                    ...
                    <button class="show-more-about_product"><a href="Keyboard.php?id='.$row['product_id'].'">Show More</a></button>
...
<body>
    ...
    <div class="lgse">
        ...
        <div class="location">
            ...
            <h3 class="hloc">></h3>
            <a class="locate" href="Keayboards.php">Klaviatūras</a>
        </div>
