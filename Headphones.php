...
if (isset($_POST['search'])) {
    ...
    $sql = "SELECT * FROM product WHERE title LIKE '%$q%' AND category='austinas'";
} else {
    $sql = "SELECT * FROM product WHERE category='austinas'";
}
    ...
    while ($row = mysqli_fetch_assoc($results)) {
        ...
        <div class="product">
            <div class="product-header">
                ...
                <a><img class="productimg" src="foto/atb/headphones/Headphones1.png"></a>
            </div>
